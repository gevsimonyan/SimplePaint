...
class Paint(Frame):
    ...
    def setUI(self):
        self.parent.title("Pythonicway PyPaint") # name of window
        self.pack(fill=BOTH , expand=1) #set elements on parent window
        self.columnconfigure(6, weight=1)
        self.rowconfigure(2, weight=1)  #same thing for third line
        ...
        color_lab.grid(row=0, column=0, padx=1)
